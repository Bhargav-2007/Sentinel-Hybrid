...
**Evaluation ID**: `2026-08-30_19-59-05` | **Git Commit**: `dev-local` (`main`) | **Timestamp**: `2026-08-30T19:59:05.688786+00:00`
...
| `M-008` | MANDATORY | Section 65B Electronic Evidence Certification | `security` | PASS 🟢 | 100.0% | 8 passed in 13.30s... |
...
- **Databases Detected**: PostgreSQL/PostGIS, MinIO S3 Object Storage, OpenSearch, Redis
