...
**Evaluation ID**: `2026-08-30_20-29-40` | **Git Commit**: `dev-local` (`main`) | **Timestamp**: `2026-08-30T20:29:40.590831+00:00`
...
| `M-008` | MANDATORY | Section 65B Electronic Evidence Certification | `security` | PASS 🟢 | 100.0% | 8 passed in 14.90s... |
...
- **Databases Detected**: Redis, OpenSearch, MinIO S3 Object Storage, PostgreSQL/PostGIS
