...
- ... and 3 more preserved components.
...
| `M-003` | MANDATORY | RTSP over TCP Transport with Monotonic PTS Pacing | `model2` | PASS 🟢 | 100.0% | Path verified: ai-detection/app/utils/video.py | 6 passed, 5... |
