...
class WatchlistCreate(BaseModel):
    ...
    identifier: str = Field(..., description="Target License Plate or Suspect ID", examples=["GJ01AB1234"])
    reason: str = Field(..., description="Case justification", examples=["Vehicle reported stolen in FIR 881/2026"])
    case_number: str = Field(..., examples=["FIR-2026-CR-0881"])
    police_station: Optional[str] = "Crime Branch Gandhinagar"
    investigating_officer: Optional[str] = "Inspector R.K. Jadeja"
